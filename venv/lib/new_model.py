...
df = pd.read_csv('/Downloads/500209.csv', header=0,
                     index_col='Date',
...
with ExcelWriter('/Stock-Prediction-Using-CNN/Forecast_Excel/500209.xlsx',
...
open_file('/Stock-Prediction-Using-CNN/Forecast_Excel/500209.xlsx')
